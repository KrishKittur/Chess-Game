...
public class Rook extends Piece {
    ...
    //Create the constructor for the Rook Piece
    Rook(int start_x, int start_y, String color) {
        super(start_x, start_y, "R", color);
    }

    //Create the get_move method for the Rook Piece
    ArrayList<int[]> get_moves() {
        ArrayList<int[]> moves = new ArrayList<int[]>();

        int[][] possibleDirs = {{1, 0}, {-1, 0}, {0, 1}, {0, -1}};
